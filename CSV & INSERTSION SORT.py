...
while True :
  ...
  submenu1 = ['1.list barang', '2.input barang', '3.list harga terurut','4.kembali ke menu utama']
  DATABASE_FILE = 'database.csv'
  database = []
#jika huruf besar semua itu konstanta
#diseynery berpaangan 
# jika menyimpan nilai itu namanya variabel gak harus ada sama dengannyaa
